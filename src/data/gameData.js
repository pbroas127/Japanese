...
export const WORLDS = [
  ...
  },
  {
    ...
    nodes: [
      { id: 'w2n1', type: 'lesson', lessonId: 'l6', label: '1', marker: 'book', place: 'Hill Path', pos: { x: 51, y: 87.2 } },
      { id: 'w2n2', type: 'lesson', lessonId: 'l7', label: '2', marker: 'study', place: 'Marsh Hollow', pos: { x: 78.2, y: 64.5 } },
      { id: 'w2n3', type: 'lesson', lessonId: 'l8', label: '3', marker: 'scroll', place: 'Valley Rise', pos: { x: 23, y: 65 } },
      { id: 'w2n4', type: 'lesson', lessonId: 'l9', label: '4', marker: 'lantern', place: 'River Bend', pos: { x: 51.5, y: 47.1 } },
      { id: 'w2n5', type: 'lesson', lessonId: 'l10', label: '5', marker: 'altar', place: 'Wood Gate', pos: { x: 74.9, y: 17.5 } },
      { id: 'w2boss', type: 'boss', lessonId: null, label: 'B', marker: 'torii', place: "Spirit's Arch", pos: { x: 22.8, y: 27.8 } },
    ],
  },
  {
    id: 'canyon',
    ...
    nodes: [
      { id: 'w3n1', type: 'lesson', lessonId: 'l11', label: '1', marker: 'book', place: 'Glade Overlook', pos: { x: 43.2, y: 90 } },
      { id: 'w3n2', type: 'lesson', lessonId: 'l12', label: '2', marker: 'study', place: 'Swamp Crossing', pos: { x: 84, y: 77.5 } },
      { id: 'w3n3', type: 'lesson', lessonId: 'l13', label: '3', marker: 'scroll', place: 'Delta Flats', pos: { x: 20.7, y: 54.5 } },
      { id: 'w3n4', type: 'lesson', lessonId: 'l14', label: '4', marker: 'lantern', place: 'Bluff Edge', pos: { x: 61.1, y: 43.3 } },
      { id: 'w3n5', type: 'lesson', lessonId: 'l15', label: '5', marker: 'altar', place: 'Peak Trail', pos: { x: 62.6, y: 20.4 } },
      { id: 'w3boss', type: 'boss', lessonId: null, label: 'B', marker: 'torii', place: "Oni's Drum", pos: { x: 55, y: 3 } },
    ],
  },
]
